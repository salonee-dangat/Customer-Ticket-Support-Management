    ...
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-4">
        ...
        <nav className="hidden md:flex space-x-6">
          ...
          <Link href="/about" className="text-gray-700 hover:text-pink-600">About Us</Link>
        ...
        <div className="hidden md:flex space-x-2">
          <Link href="/login" className="px-4 py-2 bg-pink-500 text-white rounded-lg hover:opacity-90">Login</Link>
          <Link href="/register" className="px-4 py-2 border border-pink-500 text-pink-500 rounded-lg hover:bg-pink-100">Register</Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-white shadow-md px-4 pb-4 space-y-2">
          ...
          <Link href="/login" className="block px-4 py-2 bg-pink-500 text-white rounded-lg text-center hover:opacity-90">Login</Link>
          <Link href="/register" className="block px-4 py-2 border border-pink-500 text-pink-500 rounded-lg text-center hover:bg-pink-100">Register</Link>
        </div>
      )}
    </header>
  );
